 ...
 * Created by steve
 */
public class TAMonCompteModif extends AsyncTask<String, Integer, String> {

    private TextView textViewMessage;

    public TAMonCompteModif(TextView textViewMessage) {
        super();
    ...
    protected String doInBackground(String... asParametres) {
        ...
        try {
            ...
            params += "&nom=" + URLEncoder.encode(asParametres[3], "UTF-8");
            params += "&mdp=" + URLEncoder.encode(asParametres[4], "UTF-8");
            params += "&email=" + URLEncoder.encode(asParametres[5], "UTF-8");
    ...
    protected void onPostExecute(String asResultat) {
        ...
        if (asResultat.equalsIgnoreCase("Erreur réseau")) {
            ...
            textViewMessage.setText(asResultat.trim() + " modification réalisée");
        } /// if
    } /// onPostExecute
