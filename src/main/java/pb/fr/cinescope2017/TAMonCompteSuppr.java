 ...
 * Created by steve
 */
public class TAMonCompteSuppr extends AsyncTask<String, Integer, String> {

    private TextView textViewMessage;

    public TAMonCompteSuppr(TextView textViewMessage) {
        super();
    ...
    protected void onPostExecute(String asResultat) {
        ...
        if (asResultat.equalsIgnoreCase("Erreur réseau")) {
            ...
            textViewMessage.setText(asResultat.trim() + " suppression réalisée");
        } /// if
    } /// onPostExecute
